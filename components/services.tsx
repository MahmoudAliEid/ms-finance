...
// Updated SVG Icons with orange theme
const AnalysisIcon = () => (
  <svg
    className="w-12 h-12"
    viewBox="0 0 100 100"
  ...
  const services = [
    {
      ...
      description:
        "إعداد وتحليل القوائم المالية، إدارة التدفقات النقدية، وتحسين الهيكل المالي للشركة.",
      icon: <LineChart className="h-12 w-12 text-orange-500" />,
      gradient: "from-orange-500/20 to-gray-500/20",
    },
    {
      title: "التمويل البنكي للشركات",
      description:
        "إعداد ملف التمويل بالكامل، وتجهيز الدراسات والبيانات المطلوبة للتقديم على التمويل البنكي.",
    ...
    },
    {
      ...
      description:
        "تقديم دراسات شاملة تتضمن تحليل السوق، التكاليف، العوائد، ونقاط المخاطر.",
    ...
    },
    {
      ...
      description:
        "تقييم الأداء التشغيلي، تحسين الكفاءة، وإعادة هيكلة الشركات.",
      icon: <BarChart3 className="h-12 w-12 text-gray-600" />,
      gradient: "from-gray-500/20 to-orange-500/20",
    },
    {
    ...
    },
    {
      ...
      description:
        "تقديم دراسات وتحليلات للمستثمرين لتقدير الجدوى والعوائد المتوقعة.",
      icon: <BarChart4 className="h-12 w-12 text-gray-600" />,
      gradient: "from-gray-500/20 to-orange-500/20",
    },
  ];
  ...
  return (
    <section
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          title="خدماتنا"
          subtitle="مجالات عملنا الأساسية"
        />
        ...
        {/* Work Methodology Section with updated SVG Icons */}
        <motion.div
          ...
          <div className="text-center mb-8 md:mb-12">
            ...
            <div className="w-16 md:w-24 h-1 bg-gradient-to-r from-orange-500 via-gray-500 to-orange-500 rounded-full mx-auto mb-4 md:mb-6" />
            ...
            {[
              {
                step: "01",
                title: "التحليل",
                description: "دراسة شاملة للوضع الحالي",
                icon: <AnalysisIcon />,
              },
              {
                step: "02",
                title: "التخطيط",
                description: "وضع استراتيجية مخصصة",
                icon: <PlanningIcon />,
              },
              {
                step: "03",
                title: "التنفيذ",
                description: "تطبيق الحلول المقترحة",
                icon: <ImplementationIcon />,
              },
              {
                step: "04",
                title: "المتابعة",
                description: "مراقبة النتائج والتحسين",
                icon: <MonitoringIcon />,
              },
            ].map((process, index) => (
              <motion.div
                ...
                <div className="text-center relative">
                  ...
                  <div className="relative mx-auto w-16 h-16 md:w-20 md:h-20 mb-4 md:mb-6">
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 via-gray-500/20 to-orange-500/20 rounded-full opacity-20 group-hover:opacity-30 transition-opacity duration-300" />
                    <div className="relative w-full h-full bg-gradient-to-br from-orange-500 via-gray-600 to-orange-500 rounded-full flex items-center justify-center text-white font-bold text-lg md:text-xl shadow-lg">
                      {process.step}
                    </div>
                  </div>
